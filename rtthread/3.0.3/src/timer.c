...
rt_err_t rt_timer_start(rt_timer_t timer)
{
	...
	/*获取timeout tick，最大不能大于 RT_TICK_MAX/2 */
	...
	/* 将定时器插入到定时器列表 */
	/* 获取系统定时器列表跟节点地址，rt_timer_list是一个全局变量 */
	...
	{
		/* 当系统定时器列表 rt_timer_list 为空时，该循环不执行 */
	...
	/* RT_TIMER_SKIP_LIST_LEVEL等于1，该for循环永远不会执行 */
